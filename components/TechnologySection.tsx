...
export default function TechnologySection() {
    ...
    return (
        <section ref={containerRef} className="relative h-[400vh] bg-white text-black" id="technology">
                        ...
                        {features.map((feature, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-6 left-6 text-white p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                        ...
                        {features.map((feature, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`transition-all duration-500 ${index !== 0 ? "top-1/2 -translate-y-1/2" : ""}`}
                                >
